...
//
// O banco é um diretório temporário novo a cada execução (SGCA_DATA_DIR), como
// nos testes: a captura NUNCA enxerga o sgca.db real. Isso é o que garante que
...
const dataDir = mkdtempSync(join(tmpdir(), 'sgca-shots-'));
const port = 3159;   // porta propria: nao conflita com a suite E2E (3050)
