...
rem maquina — o resto do SGCA funciona sem isso.
rem
rem Se o servidor usa o Python embarcavel (extraido por "Iniciar SGCA.bat" em
...
echo  Rode "Iniciar SGCA.bat" primeiro nesta maquina.
echo.
pause
exit /b 1
...
echo.
echo  Pronto. Reinicie o SGCA para a assinatura ICP-Brasil ficar disponivel.
echo.
pause
